...
Search workflow:
  ...
  - Keyword/topic recall: \`grep -ri "keyword" ~/.deeplake/memory/summaries/\` (use \`grep\`, NOT \`rg\`/ripgrep). You also have hivemind MCP tools registered: hivemind_search, hivemind_read, hivemind_index — prefer those when one tool call returning ranked hits is enough.
