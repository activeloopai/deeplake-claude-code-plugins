...
function ensurePluginNodeModulesLink(opts) {
  ...
  const target = opts.sharedNodeModules ?? join18(homedir12(), ".hivemind", "embed-deps", "node_modules");
  const pluginDir = dirname6(opts.bundleDir);
